 ...
 * @access public
 */
class Portfoliolite_WP_Customizer_Range_Value_Control extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'portfoliolite-range-value';
 ...
 * @since 1.1.38
 */
function portfoliolite_sanitize_range_value( $input ) {
	if ( portfoliolite_is_json( $input ) ) {
