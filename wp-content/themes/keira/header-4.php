...
<html <?php language_attributes(); ?>>
    ...
    <body class="body-hidden" <?php body_class(); ?> data-typography="syne">
        ...
        <?php 
            ...
            <?php
                if(get_theme_mod( 'wp_follow_show_hide2') === 'show' ) { ?>

            <!-- start section header follow -->
            <div class="header-follow follow-text">
                <ul>
                <?php if(get_theme_mod( 'wp_follow_target2') === 'blank' ) { ?>
                    <li>
                        <a href="<?php echo get_theme_mod( 'wp_follow_icon1_link2' , '#' ); ?>" target="_blank"><?php echo get_theme_mod( 'wp_follow_icon1_text2' , 'Facebook' ); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo get_theme_mod( 'wp_follow_icon2_link2' , '#' ); ?>" target="_blank"><?php echo get_theme_mod( 'wp_follow_icon2_text2' , 'Behance' ); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo get_theme_mod( 'wp_follow_icon3_link2' , '#' ); ?>" target="_blank"><?php echo get_theme_mod( 'wp_follow_icon3_text2' , 'Github' ); ?></a>
                    </li>
                <?php } else { ?>
                    <li>
                        <a href="<?php echo get_theme_mod( 'wp_follow_icon1_link2' , '#' ); ?>"><?php echo get_theme_mod( 'wp_follow_icon1_text2' , 'Facebook' ); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo get_theme_mod( 'wp_follow_icon2_link2' , '#' ); ?>"><?php echo get_theme_mod( 'wp_follow_icon2_text2' , 'Behance' ); ?></a>
                    </li>
                    <li>
                        <a href="<?php echo get_theme_mod( 'wp_follow_icon3_link2' , '#' ); ?>"><?php echo get_theme_mod( 'wp_follow_icon3_text2' , 'Github' ); ?></a>
                    </li>
                <?php } ?>
                </ul>
                <p class="d-none"><?php echo get_theme_mod( 'wp_follow_text2' , 'Follow Me' ); ?></p>
            </div>
